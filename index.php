...
<body>
  <div class="container">
    <div class="left-div left-text" style="min-height: 140px;">
      <div class="box-title"><button id="myBtn"><a href="afspraak.php"> Afspraak maken</a> </button> </div>
      <p>
      </p>
      </div>
    <div class="right-div right-text" style="min-height: 140px">
        <div class="box-title"> <h2>Informatie & formulier</h2></div>
<a href="paspoort.php">Paspoort</a><br>
<a href="uittreksel.php">Uittreksel</a><br>
<a href="kapvergunning.php">Kapvergunning</a><br>
    </div>
    <div class="left-div left-text style" style="min-height: 140px">
      <div class="box-title"> <button id="myBtn"><a href="contact.php"> Contact </a></button> </div>
      <p>
</body>
